...
class ArrayList:
    ...
    def __str__(self):
        ...
        for l in range(len(self.data) - 1):
            output_str = output_str + str(self.data[l]) + ', '
        output_str = output_str + str(self.data[len(self.data) - 1]) + ']'
        return output_str
        ### END SOLUTION
    ...
    def __iter__(self):
        ...
        ### BEGIN SOLUTION cursor = self.head.next  # Must advance past non-valued head
